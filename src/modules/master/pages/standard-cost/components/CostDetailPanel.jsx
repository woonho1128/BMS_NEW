...
import { Alert, Button, Col, Input, InputNumber, message, Row, Select, Statistic, Tabs } from 'antd';
          ...
          <TabPane tab="상세 정보" key="info">
            <div className="grid-2-col">
              <div className="input-column">
                ...
                <div className="form-row">
                  <label>중량 (kg)</label>
                  <InputNumber value={formData.weight} onChange={(v) => handleChange('weight', v)} style={{ width: '100%' }} />
                </div>
                <div className="form-row">
                  <label>물류비</label>
                  <InputNumber
                ...
                <div className="form-row">
                  <label>기타원가율(%)</label>
                  <InputNumber value={formData.otherRate} onChange={(v) => handleChange('otherRate', v)} style={{ width: '100%' }} />
                </div>
                <div className="form-row">
                  <label>판매마진율(%)</label>
                  <InputNumber value={formData.marginRate} onChange={(v) => handleChange('marginRate', v)} style={{ width: '100%' }} />
                </div>
              </div>
