    ...
    children: [
      ...
      /* 시장 분석 */
      {
        ...
        children: [
          ...
          {
            id: 'analytics-data-collection',
            label: '자료수집',
            children: [
              { id: 'analytics-data-price', label: '단가표', path: '/analytics/data-collection/price' },
              { id: 'analytics-data-catalog', label: '카달로그', path: '/analytics/data-collection/catalog' },
              { id: 'analytics-data-promo', label: '판매자료(프로모션 등)', path: '/analytics/data-collection/promo' },
            ]
          },
        ],
      },
