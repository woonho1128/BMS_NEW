    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          {/* ── 영업 활동 (공통) — 추가 메뉴 ── */}
          <Route path={toRelative(ROUTES.SALES_DELIVERY_REQUEST_STATUS)} element={<PlaceholderPage path={ROUTES.SALES_DELIVERY_REQUEST_STATUS} description="출고 요청 진행 현황 페이지입니다." icon="🚚" />} />
          <Route path={toRelative(ROUTES.SALES_DELIVERY_REQUEST_DETAIL)} element={<PlaceholderPage path={ROUTES.SALES_DELIVERY_REQUEST_DETAIL} description="출하 요청 상세내역 조회 페이지입니다." icon="📑" />} />
          <Route path={toRelative(ROUTES.SALES_DELIVERY_APPROVAL)} element={<PlaceholderPage path={ROUTES.SALES_DELIVERY_APPROVAL} description="출고 승인 페이지입니다." icon="✅" />} />
          ...
          <Route path={toRelative(ROUTES.SALES_SUPPORT_DISCOUNT_LIST)} element={<PlaceholderPage path={ROUTES.SALES_SUPPORT_DISCOUNT_LIST} description="단가표 관리 메뉴 영역입니다." icon="💰" />} />
          <Route path={toRelative(ROUTES.SALES_SUPPORT_DISCOUNT_RATE)} element={<PlaceholderPage path={ROUTES.SALES_SUPPORT_DISCOUNT_RATE} description="거래처별 할인율 조회 메뉴 영역입니다." icon="📉" />} />
          <Route path={toRelative(ROUTES.SALES_SUPPORT_DISCOUNT_PROMOTION)} element={<PlaceholderPage path={ROUTES.SALES_SUPPORT_DISCOUNT_PROMOTION} description="프로모션 관리 메뉴 영역입니다." icon="🎁" />} />
